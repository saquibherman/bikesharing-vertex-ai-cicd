...
--project=deepfake-399413 \
--worker-pool-spec=replica-count=1,machine-type='n1-standard-4',container-image-uri='gcr.io/deepfake-399413/cicd-vertex-bikeshare-model' \
...
--artifact-uri='gs://saquib-vertex-mlops/bike-share-rf-regression-artifact/' \
--project=deepfake-399413 --region=us-central1
